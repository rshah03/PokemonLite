...
function move1() {
    ...
    var crit = criticalHit();
    var critCompareTo = Math.floor(Math.random() * 3);
    if (crit > critCompareTo) {
        move.damage += 5;
        $('#dialog-message').html(Lugia.pokemonName + ' used ' + move.moveName + 'Critical hit!');
    } else {
